...
use crate::rewrite::{Cone, Rewrite0, RewriteN};
use crate::Generator;
use crate::{graph::GraphBuilder, Diagram, Height, Rewrite, SliceIndex};
...
pub type Label = (Generator, Simplex<Height>);
...
mod test {
    use crate::DiagramN;
    use crate::{common::Boundary, examples};
